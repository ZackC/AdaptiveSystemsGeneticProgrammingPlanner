...
master - the original JGAP implementation for the position paper SASS: 
    ...
    paths that a new user of the system will get an error for and have to 
    adjust.  Examples of the generaetedPrismFile.pm and 
    generatedPropertyFile.pctl are in the src/main folder. The tool 
    requires an installation of the PRISM model checker. There have been
    ...
    completion. The main function of the tool is located in 
    src/main/runGA.java.  This project was created as an eclipse 
    project, and can be easily loaded and built as one (at the moment). Many
    of these instructions are specific to the implementation of the main 
    branch and do not apply to other branches.
